export default function AboutUs({ t }) {
    return (
        <section id="services" className="services section-padding" data-scroll-index="1">
            <div className="container">
                <div className="row">
                    <div className="col-md-12">
                        <h2 className="section-title" dangerouslySetInnerHTML={{__html: t('About Us Title')}}></h2>
                    </div>
                </div>
                <div className="row">
